...
def test_checked_in_pilot_is_waiting_with_zero_target_writes() -> None:
    ...
    assert readiness["status"] == "WAITING_OPERATOR_MUTEX_CONFIRMATION"
    ...
    assert readiness["operator_confirmation_count"] == 1
